...
export class WalletMnemonicRestore extends Component<WalletMnemonicRestoreProps, WalletMnemonicRestoreState> {
            ...
            <form /*onSubmit={handleSubmit}*/>
                <Box direction="column" align="center" width="100%">
                    <Box direction="column" width="700px" align="start" margin="0 auto 0 auto">
                        <BackButton onClick={() => this.props.onCancel() } margin="150px 0 0 -100px" />
