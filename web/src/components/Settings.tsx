...
export class Settings extends Component<SettingsProps, SettingsState> {
  ...
  private updateIceConfig = async () => {
    let IceServer: IceServerConfig = {
      URL: this.state.URL ? this.state.URL : this.state.config ? this.state.config.IceServers[0].URL : "",
      UserName: this.state.UserName ? this.state.UserName : this.state.config ? this.state.config.IceServers[0].UserName : "",
      Credential: this.state.Credential ? this.state.Credential : this.state.config ? this.state.config.IceServers[0].Credential : "",
    };
  ...
  private updateWebServerConfig = async () => {
    let webserver: WebServerConfig = {
      BindAddress: this.state.BindAddress ? this.state.BindAddress : this.state.config ? this.state.config.WebServer.BindAddress : "",
      ListenPort: this.state.ListenPort ? this.state.ListenPort : this.state.config ? this.state.config.WebServer.ListenPort : 0,
      AllowCIDR: this.state.AllowCIDR ? this.state.AllowCIDR : this.state.config ? this.state.config.WebServer.AllowCIDR : "",
    };
            ...
            <Form.Group className="leftAlign field" widths="equal">
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state && this.state.config ? this.state.config.IceServers[0].URL : ""}
                />
              </Form.Field>
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state && this.state.config ? this.state.config.IceServers[0].UserName : ""}
                />
              </Form.Field>
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state && this.state.config ? this.state.config.IceServers[0].Credential: ""}
                />
              </Form.Field>
            </Form.Group>
            ...
            <Form.Group className="leftAlign field" widths="equal">
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state ? this.state.BindAddress ? this.state.BindAddress : this.state.config ? this.state.config.WebServer.BindAddress : "" : "" }
                />
              </Form.Field>
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state ? this.state.ListenPort ? this.state.ListenPort : this.state.config ? this.state.config.WebServer.ListenPort : "" : "" }
                />
              </Form.Field>
              <Form.Field>
                <Form.Input
                  ...
                  defaultValue={this.state ? this.state.AllowCIDR ? this.state.AllowCIDR : this.state.config ? this.state.config.WebServer.AllowCIDR : "" : "" }
                />
              </Form.Field>
            </Form.Group>
